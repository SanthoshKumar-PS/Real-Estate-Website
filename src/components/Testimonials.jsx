...
const Testimonials = () => {
  return (
    <div className="container mx-auto py-10 lg:px-32 w-full overflow-hidden" id="Testimonials">
        ...
        <p className="text-center text-gray-500 mb-12 max-w-76 mx-auto">Real stories from those who found home with us</p>

        <div className="flex flex-col md:flex-row items-center justify-center gap-8">
            {testimonialsData.map((testimonial, index)=>(
                <div key={index} className="max-w-[340px] border border-zinc-400 shadow-lg rounded px-8 py-12 text-center">
